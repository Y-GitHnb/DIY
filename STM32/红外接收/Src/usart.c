...
uint8_t UART1_Rx_Buf[BUFFER_SIZE] = {0};
...
void MX_USART1_UART_Init(void)
{
	...
	// HAL_UARTEx_ReceiveToIdle_DMA(&huart1, UART1_Rx_Buf, BUFFER_SIZE);
...
void USART_manage(void)
{
	if (UART1_Rx_flag)
	{
		DMA_Usart_Send(&huart1, UART1_Rx_Buf, UART1_Rx_cnt);

		UART1_Rx_cnt = 0;
		UART1_Rx_flag = 0;
		memset(UART1_Rx_Buf, 0, UART1_Rx_cnt);
